...
class gfg
{
	    ...
	    void splitList(circular_LinkedList list)
        {
             ...
             while(fast!=head && fast.next!=head){//null hoga hi nahi kyuki circular linked list hai
                 slow=slow.next;
                 fast=fast.next.next;
             }
             ...
             head1=head;
             head2=slow.next;
             slow.next=head1; //because wapis se circular linked lilst banana hai
             //to first wale ka to easily hogya ...second wale a traverse krke laast tak jaaan padega
             ...
             temp.next=head2; //idhar list 2 bhi circular ban gaya
